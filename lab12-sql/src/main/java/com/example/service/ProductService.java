...
public class ProductService {
    ...
    public String productQuery(String userQuery) {
        ...
        //  TDODO-12: Call the AIClient to generate the SQL query.
        //  Pass the query parameter to the generateSql() method:
        var query = aiClient.generateSql(userQuery);

        //  TDODO-13: Call the ProductDao to execute the SQL query.
        //  Pass the SQL query generated above.
        //  Capture the results in a List<Map<String,Object>> variable.
        List<Map<String, Object>> result = productDao.adHocQuery(query);

        //  TDODO-14: Remove the "return null;" statement.
        ...
        return aiClient.summarize(userQuery, result.toString());
    }
