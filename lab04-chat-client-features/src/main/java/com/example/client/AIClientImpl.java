...
public class AIClientImpl implements AIClient {
    ...
    //  TDODO-04: Define a member variable of type InMemoryChatMemory.
    ...
    //  TDODO-05: Defined a member variable of type MessageChatMemoryAdvisor.
    ...
    public AIClientImpl(final ChatModel model) {
        client = ChatClient
            ...
            //  TDODO-06: Alter this ChatClient.
    ...
    public String conversationalChat(String input, int conversationId){
        return 
            client
                ...
                // TDODO-07:  Use the .advisors() method to inject an AvisorSpec Consumer to this call.
    ...
    // TDODO-08:  Return to the @Test method in AIClientImplTests.
