...
//  TDODO-11: Define this test class as a Spring Boot test.
...
public class AIClientImplTests {
    ...
    //  TDODO-12: Use the @Autowired annotation to inject an instance of the AIClient.
    @Autowired private AIClient client;

    //  TDODO-13: Write a @Test method to validate the AIClient.
    ...
    //  TDODO-14: Save all work.  Run this test, it should pass.
